...
async function process(ctx) {
  ...
  const decoded = await (0, _encoding.decodeContent)(destResBody, encoding, charset);
  ...
  for (const processor of RESOURCE_PROCESSORS) {
    ...
    if (_page.default === processor) await ctx.prepareInjectableUserScripts(); // @ts-ignore: Cannot invoke an expression whose type lacks a call signature
